...
<body>
    ...
    <%  ArrayList<Integer> arraylist = new ArrayList<Integer>();
        ...
        out.println("&nbsp &nbsp &nbsp &nbsp &nbsp <h1 style='display:inline-block;color:blue;padding:5px;border:2px solid #616161;'>Your cart</h1>");
        out.println("<table class='table table-bordered'> <thead class='thead-dark'><tr><th>Item Name</th><th>Quantity</th><th>Total</th></tr></thead>");
        float count = 0;
        if (sports != null) {
